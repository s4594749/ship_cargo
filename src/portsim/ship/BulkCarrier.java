...
public class BulkCarrier extends Ship {
     ...
     * BulkCarrier.
     * <p>
     * For two BulkCarriers to be equal, they must have the same name,
     * flag, origin flag, IMO number, and tonnage capacity.
     *
    ...
    public boolean equals(Object o) {
        ...
        BulkCarrier other = (BulkCarrier) o;

        if (other.tonnageCapacity != this.tonnageCapacity) {
            return false;
        }
     ...
     * <p>
     * Two BulkCarriers that are equal according to {@link BulkCarrier#equals(Object)} method
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), this.tonnageCapacity);
    }
     ...
     *   <li>{@code id} is the ID of the cargo on the ship or an empty string ""
     *   if there is none</li>
     * </ul>
     * For example:
     *
    ...
    public String encode() {
        String base = super.encode() + ":" + this.tonnageCapacity + ":";
        return this.cargo != null ? base + this.cargo.getId() : base;
    }
}
